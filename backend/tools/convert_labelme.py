"""Convert LabelMe JSON annotations to a YOLO dataset."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="LabelMe JSON to YOLO dataset converter")
    parser.add_argument("--json-dir", default="datasets/rsod/raw/labelme_annotations")
    ...
    stats = DataConverter.labelme_to_yolo(args.json_dir, str(temp_labels), class_mapping)
    ...
    print(f"LabelMe converted: {stats}")
